...
const configured = (process.env.FMS_ROUTES || 'A1,A2,D1,D2,E,K,R1,R2')
...
const COLORS = { A1: '#FB0101', A2: '#FBAE17', D1: '#9E005D', D2: '#6A1B9A', E: '#00838F', K: '#2E7D32', R1: '#10B981', R2: '#8B5CF6' };
