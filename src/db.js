...
import { ACTIVE_WINDOW_MS, DAY_MS, BUCKET_MS, POLL_BATCH_COLUMNS, SNAPSHOT_SCHEMA, AGGREGATE_COLUMNS, queryRange, normalizePoll } from './db_shared.js';
...
// A partial cloud configuration is an error; never silently write to temporary storage.
export const dbInstance = process.env.TURSO_DATABASE_URL !== undefined || process.env.TURSO_AUTH_TOKEN !== undefined
  ? new RemoteBusDatabase()
  : new BusDatabase();
